...
class ResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create response" do
    assert_difference('Response.count') do
      post responses_url, params: { response: { message: @response.message, user_id: @response.user_id } }
    end
  ...
  test "should update response" do
    patch response_url(@response), params: { response: { message: @response.message, user_id: @response.user_id } }
